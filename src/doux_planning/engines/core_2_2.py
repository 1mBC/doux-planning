# core-2.2: fill fewest + repair légal (+4h, off_days, revert if interdit↑ or global↓)
...
# core-2.2: hours beyond contract accepted during repair
...
def _can_repair_fill(
    ...
    """Check if employee can fill this window under repair rules (with off_days check)."""
    weekday = WEEKDAYS[day_index % 7]
...
def _repair_empty_posts(
    ...
    """Attempt to fill empty posts respecting off_days. Returns repair stats."""
...
def generate_cycle(draft: PlanningDraft, search: SearchEffort | None = None) -> EngineResult:
    ...
    def consider(off_days: dict[str, set[int]]) -> None:
        ...
        repairs = {"attempted": empty_before, "filled": 0, "remaining": empty_before, "skipped_illegal": 0}
