...
- **THEN** `published.salle` has assignments (and any engine warnings) on the salle grid, cuisine shows « Pas encore calculé », and Calculer is disabled on cuisine
