...
Uniquement `web/`. Proxy Vite `/v1` inchangé. API = uvicorn `master` + worker Compose. Version `0.25.0`. Hors slice : rotate invite-token, delete salarié, édition des poids, bench admin.
