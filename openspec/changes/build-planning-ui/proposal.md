...
Uniquement `web/`. Proxy Vite `/v1` inchangé. L’API snapshot tourne à part (ne pas merger `snapshot/infra` / `snapshot/core`). Types = JSON du contrat. Version `0.17.0`. Hors slice : exports, polish invite/types/we, rotate invite-token.
