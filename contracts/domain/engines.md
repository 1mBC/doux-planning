...
src/doux_planning/engines/
  ...
  core_1.py
  core_2.py
  core_2_1.py    # fill fewest + repair empty posts
  core_3.py
  core_4.py
...
`core-2.1` : idem + `repairs: { attempted, filled, remaining }`.  
...
- `list_engine_refs() == ("core-0","core-1","core-2","core-2.1","core-3","core-4","core-5","core-6","cp-0","iter-0")`.
