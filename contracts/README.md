...
| 75 — leftover + 11 h wrap + every_two au moins un | `domain/coverage-rest-weekend.md`, `wellbeing.md`, `score-facts.md` ; briefs `core-coverage-rest-weekend.md`, `ui-coverage-rest-weekend.md` | **freeze** |
