...
| 41 — oracles + pile workers | `domain/bench.md`, `domain/worker-queue.md`, `domain/generate-jobs.md`, `deploy/railway.md` ; briefs `core-bench-oracles.md`, `infra-worker-queue.md`, `ui-bench-oracles.md` | **ouvert** |
